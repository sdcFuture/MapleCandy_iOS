...
extension GATTClientController
{
    ...
    {
        gattServer?.writeValue(value, for: characteristic, type: .withoutResponse)
...
extension GATTClientController
{
    ...
    func peripheral(_ peripheral: CBPeripheral, didUpdateValueFor descriptor: CBDescriptor, error: Error?)
    {
        ...
        //call delegate methods
        delegate?.gattClient(recievedNewValueFor: descriptor, value: updatedValue, error: error)
    ...
    func peripheral(_ peripheral: CBPeripheral, didWriteValueFor descriptor: CBDescriptor, error: Error?)
    {
        ...
        //call delegate method
        delegate?.gattClient(wroteValueFor: descriptor, error: error)
